/* Execute os comandos abaixo para criar uma nova tabela: */
...
/* Para mostrar o conteúdo da tabela, execute: */
SELECT * FROM TAB_IDENTITY;

/* Para inserir linhas na tabela, execute: */
...
/* Insira uma linha com este comando: */
INSERT INTO TAB_PADRAO (DESCRITOR) VALUES ('CLIENTE 2');

/* Veja como a tabela ficou. */

/* Apague o conteúdo das tabelas: */
DELETE FROM ITENS_NOTAS;
DELETE FROM NOTAS;

/* Busque o conteúdo das tabelas: */
...
/* Insira uma linha, executando o comando: */
...
INSERT INTO TAB_FATURAMENTO
SELECT
N.DATA_VENDA, SUM(ITN.QUANTIDADE

 * ITN.PRECO) AS FATURAMENTO
FROM
NOTAS N
INNER JOIN
ITENS_NOTAS ITN
...
/* Crie um script novo para montar uma TRIGGER com o comando: */
...
/* Crie um novo script e mostre o conteúdo das tabelas: */
SELECT * FROM TAB_FATURAMENTO;
SELECT * FROM NOTAS;

/* Altere a linha da tabela: */
UPDATE ITENS_NOTAS SET QUANTIDADE = 1000 WHERE NUMERO = '005';

/* Apague o item 005 das tabelas: */
...
/* Altere o conteúdo do registro: */
UPDATE ITENS_NOTAS SET QUANTIDADE = 1000 WHERE NUMERO = '007';

/* Apague as linhas com 007 das tabelas: */
